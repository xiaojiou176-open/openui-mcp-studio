...
const PROJECT_ENV_KEY_PATTERN =
	/^(?:(?:OPENUI|GEMINI|GOOGLE|LIVE_TEST|CI_GATE|FILE_GOVERNANCE)_[A-Z0-9_]+|NEXT_PUBLIC_SITE_URL)$/u;
...
const STAGED_DIFF_ENV_SIGNAL_PATTERN =
	/\b(?:process\.env|os\.environ|os\.getenv|OPENUI_[A-Z0-9_]*|GEMINI_[A-Z0-9_]*|GOOGLE_[A-Z0-9_]*|CI_GATE_[A-Z0-9_]*|FILE_GOVERNANCE_[A-Z0-9_]*|NEXT_PUBLIC_SITE_URL|RUN_EXTERNAL_E2E|CI)\b/u;
