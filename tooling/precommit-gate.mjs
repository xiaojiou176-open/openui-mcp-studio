	...
	"precommit-strict": [
		{
			...
			tasks: [
				...
				{
					name: "tracked-surface-hygiene",
					command: NPM_BIN,
					args: ["run", "-s", "governance:tracked-surface:check"],
				},
				{
					name: "sensitive-surface-audit",
					command: NPM_BIN,
					args: ["run", "-s", "security:sensitive-surface:audit"],
				},
				{
				...
				},
				{
					name: "host-safety",
					command: "node",
					args: ["tooling/check-host-safety.mjs"],
				},
				{
					name: "lint-staged",
					command: NPM_BIN,
