...
| `openuistudio skills starter --json` | machine-readable starter-pack and bundle truth for the repo-owned public package layer | not proof of an official marketplace or catalog listing |
| `openuistudio ecosystem-guide --json` | current public distribution package, OpenClaw public-ready bundle, and supporting-lane truth in one CLI packet | not proof of vendor approval or registry publication |
...
![OpenUIStudio front door showing the direct path to the operator desk](./assets/openuistudio-workbench.png)
