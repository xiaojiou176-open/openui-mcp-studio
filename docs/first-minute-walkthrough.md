...
> Is ShadcnBrief worth another minute of attention?
...
- Use [Discussions](https://github.com/xiaojiou176-open/shadcn-brief/discussions) if you want to see how the repo is meant to be talked about in public.
