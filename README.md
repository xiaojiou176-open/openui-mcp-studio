...
OpenUIStudio is for teams that want one practical flow: start from a
...
[![Release](https://img.shields.io/github/v/release/xiaojiou176/openuistudio?display_name=tag&label=release)](https://github.com/xiaojiou176/openuistudio/releases)
...
[Releases](https://github.com/xiaojiou176/openuistudio/releases) |
...
<p align="center">
  <img
    src="./docs/assets/openuistudio-workbench.png"
    alt="OpenUIStudio front door showing the direct path to proof and the operator desk"
    width="100%"
  />
</p>
...
<p align="center">
  <img
    src="./docs/assets/openuistudio-visitor-paths.png"
...
> OpenUIStudio is an MCP-native AI UI/UX delivery and review workbench for
...
- **current repo-owned package and runtime surfaces**
  ...
  - supporting self-hosted OpenUI Hosted API command surface through `openuistudio hosted ...`
- **later lanes**
...
- Builder-surface lane
  ...
  - the builder layer now has a more formal read order through
    `openuistudio surface-guide`, richer builder metadata, and thicker
...
- a supporting self-hosted OpenUI Hosted API command surface through `openuistudio hosted ...`
