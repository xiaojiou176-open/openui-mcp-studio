...
type RunManagedInstallSurfaceSuccessJanitor = (input?: {
	rootDir?: string;
	env?: NodeJS.ProcessEnv;
	trigger?: string;
}) => Promise<{
...
const { prepareManagedInstallSurface, runManagedInstallSurfaceSuccessJanitor } =
	requireFromCurrentFile(
	"../../../../tooling/shared/managed-install-surface.mjs",
) as {
	prepareManagedInstallSurface: PrepareManagedInstallSurface;
	runManagedInstallSurfaceSuccessJanitor: RunManagedInstallSurfaceSuccessJanitor;
};
