...
const registerPlanTool = vi.fn();
const registerQualityTool = vi.fn();
const registerRagTool = vi.fn();
const registerRefineTool = vi.fn();
const registerRepoWorkflowSummaryTool = vi.fn();
const registerReviewBundleTool = vi.fn();
const registerShipTool = vi.fn();
const registerShipFeatureFlowTool = vi.fn();
const registerSmokeTool = vi.fn();
const registerAcceptanceTool = vi.fn();
const registerUiuxReviewTool = vi.fn();
const registerWorkspaceScanTool = vi.fn();
...
vi.mock("../services/mcp-server/src/tools/plan.js", () => ({
	registerPlanTool,
}));
...
vi.mock("../services/mcp-server/src/tools/repo-workflow-summary.js", () => ({
	registerRepoWorkflowSummaryTool,
}));
vi.mock("../services/mcp-server/src/tools/review-bundle.js", () => ({
	registerReviewBundleTool,
}));
vi.mock("../services/mcp-server/src/tools/ship.js", () => ({
	registerShipTool,
}));
vi.mock("../services/mcp-server/src/tools/ship-feature-flow.js", () => ({
	registerShipFeatureFlowTool,
}));
vi.mock("../services/mcp-server/src/tools/smoke.js", () => ({
	registerSmokeTool,
}));
vi.mock("../services/mcp-server/src/tools/acceptance.js", () => ({
	registerAcceptanceTool,
}));
vi.mock("../services/mcp-server/src/tools/uiux-review.js", () => ({
	registerUiuxReviewTool,
}));
vi.mock("../services/mcp-server/src/tools/workspace-scan.js", () => ({
